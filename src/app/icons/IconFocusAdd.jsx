// icon:focus-add | Unicons https://iconscout.com/unicons | Iconscout
import * as React from "react";

function IconFocusAdd({ fill, filled, size, height, width, label, ...props }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={fill}
